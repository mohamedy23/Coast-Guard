...
class comparableNodeAStar implements Comparator<Node> {

    @Override
	public int compare(Node n1, Node n2) {
    	if(n1.pathCost[0]+n1.pathCost[2] != n2.pathCost[0]+n2.pathCost[2])
			return Integer.compare(n1.pathCost[0]+n1.pathCost[2],n2.pathCost[0]+n2.pathCost[2]);
		else
...
public class AStar extends Search {
	...
	public static String SearchAS(String grid,String strategy,boolean visualize) {
		...
		PriorityQueue<Node> nodes = new PriorityQueue<Node>(new comparableNodeAStar());
		...
		while(!nodes.isEmpty()) {
			...
			if(strategy.equals("AS1"))expand(current,expandedNodes,nodes,n,m, current.state.ships,stations);
